...
class MlInit
{
    ...
    function up()
    {
        ...
        array('id'), false, 'InnoDB', 'utf8_unicode_ci');
		\DBUtil::create_index(\Config::get('monitoredlogin.table.blocked_ips', 'ml_blocked_ip'), 'name');
    ...
    function down()
    {
       ...
       \DBUtil::drop_table(\Config::get('monitoredlogin.table.blocked_users', 'ml_blocked_ip'));
       \DBUtil::drop_table(\Config::get('monitoredlogin.table.login_attempts', 'ml_login_attempt'));
    }
}

/* End of file 001_mlinit.php */